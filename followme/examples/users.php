...
if (!isset($_SESSION)) {
  ...
  $sql3 = "SELECT user_id, first_name, last_name, title, image_url FROM fm_users";
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    while ($row2 = $result2->fetch_assoc()) {
      ...
      $sql3 = "INSERT IGNORE INTO fm_followers (user_id, following_user_id) VALUES ('$userid','$follow_id')";
      $conn->query($sql3);
    }
        ...
        $follow_id = $row2['user_id'];
        $sql3 = "DELETE FROM fm_followers WHERE user_id = '$userid' AND following_user_id = '$follow_id'";
        $conn->query($sql3);
      }
    }
  }
